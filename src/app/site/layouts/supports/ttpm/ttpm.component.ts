...
@Component({
  selector: 'app-ttpm',
  templateUrl: './ttpm.component.html',
  styleUrls: ['./ttpm.component.css']
})
export class TtpmComponent implements OnInit {

  subscription: Subscription;
  supports: Supports = { id: null, user_id: null,title: '', description: null, class_id: null, support_room: 1, date: '', status: 0};
  classes: Class[] = [];
  news: any;
  dataNews: any;
  public pageSize = 5;
